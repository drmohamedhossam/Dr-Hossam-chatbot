...
export default function DrHossamChatbot() {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      const reply =
        data?.content?.[0]?.text || "عذرًا، حدث خطأ. حاول مرة تانية.";
      ...
      setMessages([
        ...
        {
          role: "assistant",
          content: "عذرًا، في مشكلة في الاتصال. اتصل بينا على 01553002461",
        },
      ]);
    } finally {
      setLoading(false);
  ...
  return (
    <div
      ...
      style={{
        minHeight: "100vh",
        background: "linear-gradient(135deg, #0a1628 0%, #0d2444 50%, #0a1f3a 100%)",
        display: "flex",
        alignItems: "center",
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header::before {
          ...
          background: radial-gradient(circle, rgba(64,140,255,0.15) 0%, transparent 70%);
          border-radius: 50%;
        }
        ...
        <div className="header">
          <div style={{ display: "flex", gap: "14px", alignItems: "center" }}>
            <div style={{ position: "relative" }}>
              <img src={DOCTOR_PHOTO} alt="د. محمد حسام" style={{width:"100%",height:"100%",objectFit:"cover",borderRadius:"50%"}} />
              <div className="online-dot" />
            </div>
            <div style={{ flex: 1 }}>
              <div style={{ color: "#e2eeff", fontWeight: 700, fontSize: "15px", fontFamily: "'Cairo', sans-serif" }}>
                د. محمد حسام الدين
              </div>
              <div style={{ color: "#93c5fd", fontSize: "12px", marginTop: "2px", fontFamily: "'Cairo', sans-serif" }}>
                استشاري الطب النفسي وعلاج الإدمان
              </div>
              <a href="tel:01553002461" className="phone-chip">
                📞 01553002461
              </a>
            </div>
            <div style={{
        ...
        <div className="messages">
          {messages.map((m, i) => (
            <div key={i} className={`bubble-wrap ${m.role}`}>
              {m.role === "assistant" && (
                <img src={DOCTOR_PHOTO} alt="د." style={{width:"28px",height:"28px",objectFit:"cover",borderRadius:"50%",border:"1px solid rgba(100,160,255,0.3)",flexShrink:0}} />
              )}
